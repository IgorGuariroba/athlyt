...
![Referência](./016-selecionar-peso.JPG)
...
- **Estado documentado:** Selecionar Peso.
- **Navegação:** barra superior com retorno ou título quando aplicável; ações principais aparecem geralmente em botão largo no rodapé; nas áreas principais do app há barra de abas inferior.

## Identificação

- **Arquivo da imagem:** `016-selecionar-peso.JPG`
- **Posição no conjunto:** 16 de 186

## Sequência

- **Anterior:** `015-altura-centimetros.JPG`
- **Próxima:** `017-historico-peso.JPG`
