# 114 — Exercicio Com Super Set

![Imagem de referência](./114-exercicio-com-super-set.JPG)

## Identificação

- **Arquivo da imagem:** `114-exercicio-com-super-set.JPG`
- **Posição no workflow:** 114 de 134
- **Etapa:** Exercicio Com Super Set

## Descrição da tela

Tela dedicada a um exercício, exibindo parâmetros ou histórico de séries, repetições, carga e intensidade. O conteúdo central corresponde a **exercicio com super set**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “exercicio com super set”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Exercicio Com Super Set** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `113-exercicio-com-historico-expandido.JPG`
- **Próxima:** `115-exercicio-com-carga-negativa.JPG`
