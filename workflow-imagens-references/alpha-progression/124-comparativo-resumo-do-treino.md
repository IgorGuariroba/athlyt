# 124 — Comparativo Resumo Do Treino

![Imagem de referência](./124-comparativo-resumo-do-treino.JPG)

## Identificação

- **Arquivo da imagem:** `124-comparativo-resumo-do-treino.JPG`
- **Posição no workflow:** 124 de 134
- **Etapa:** Comparativo Resumo Do Treino

## Descrição da tela

Tela do fluxo de treino, com exercícios, séries, repetições, carga, RIR e ações de execução. O conteúdo central corresponde a **comparativo resumo do treino**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “comparativo resumo do treino”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Comparativo Resumo Do Treino** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `123-grafico-biceps-seis-meses.JPG`
- **Próxima:** `125-conquistas.JPG`
