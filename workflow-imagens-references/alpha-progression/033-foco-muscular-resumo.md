# 033 — Foco Muscular Resumo

![Imagem de referência](./033-foco-muscular-resumo.JPG)

## Identificação

- **Arquivo da imagem:** `033-foco-muscular-resumo.JPG`
- **Posição no workflow:** 33 de 134
- **Etapa:** Foco Muscular Resumo

## Descrição da tela

Tela de seleção de grupos musculares, com ilustrações do corpo e controles de foco ou negligência. O conteúdo central corresponde a **foco muscular resumo**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “foco muscular resumo”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Foco Muscular Resumo** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `032-foco-muscular-selecionado.JPG`
- **Próxima:** `034-foco-muscular-confirmado.JPG`
