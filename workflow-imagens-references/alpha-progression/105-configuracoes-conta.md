# 105 — Configuracoes Conta

![Imagem de referência](./105-configuracoes-conta.JPG)

## Identificação

- **Arquivo da imagem:** `105-configuracoes-conta.JPG`
- **Posição no workflow:** 105 de 134
- **Etapa:** Configuracoes Conta

## Descrição da tela

Tela de configurações do aplicativo, organizada em linhas e seções com opções navegáveis ou chaves. O conteúdo central corresponde a **configuracoes conta**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “configuracoes conta”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Configuracoes Conta** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `104-selecionar-unidade-de-peso.JPG`
- **Próxima:** `106-novidades-da-versao.JPG`
