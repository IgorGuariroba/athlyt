...
![Imagem de referência](./092-configuracoes.JPG)

## Identificação

- **Arquivo da imagem:** `092-configuracoes.JPG`
- **Posição no workflow:** 92 de 134
- **Etapa:** Configuracoes

## Descrição da tela

Tela de configurações do aplicativo, organizada em linhas e seções com opções navegáveis ou chaves. O conteúdo central corresponde a **configuracoes**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “configuracoes”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Configuracoes** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `091-perfil.JPG`
- **Próxima:** `093-configuracoes-aparencia.JPG`
