# 113 — Exercicio Com Historico Expandido

![Imagem de referência](./113-exercicio-com-historico-expandido.JPG)

## Identificação

- **Arquivo da imagem:** `113-exercicio-com-historico-expandido.JPG`
- **Posição no workflow:** 113 de 134
- **Etapa:** Exercicio Com Historico Expandido

## Descrição da tela

Tela dedicada a um exercício, exibindo parâmetros ou histórico de séries, repetições, carga e intensidade. O conteúdo central corresponde a **exercicio com historico expandido**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “exercicio com historico expandido”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Exercicio Com Historico Expandido** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `112-calendario-dia-selecionado.JPG`
- **Próxima:** `114-exercicio-com-super-set.JPG`
