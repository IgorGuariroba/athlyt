# 034 — Foco Muscular Confirmado

![Imagem de referência](./034-foco-muscular-confirmado.JPG)

## Identificação

- **Arquivo da imagem:** `034-foco-muscular-confirmado.JPG`
- **Posição no workflow:** 34 de 134
- **Etapa:** Foco Muscular Confirmado

## Descrição da tela

Tela de seleção de grupos musculares, com ilustrações do corpo e controles de foco ou negligência. O conteúdo central corresponde a **foco muscular confirmado**. A tela apresenta título no topo, conteúdo principal organizado em cartões, listas, seletores ou painéis e, quando aplicável, uma ação de avanço, confirmação, salvamento ou fechamento.
...
- **Área principal:** informações e controles referentes a “foco muscular confirmado”.
- **Área inferior:** quando presente, botão principal em largura ampla ou barra de navegação por abas.

## Finalidade no fluxo

Esta referência documenta a etapa **Foco Muscular Confirmado** e deve ser usada para reproduzir a hierarquia visual, os estados dos controles, o espaçamento e a navegação mostrados na captura.

## Navegação na sequência

- **Anterior:** `033-foco-muscular-resumo.JPG`
- **Próxima:** `035-plano-frequencia-semanal.JPG`
