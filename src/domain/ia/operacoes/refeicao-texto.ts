 ...
 * modelo consegue ver. Por isso cada item carrega, além das gramas
 * estimadas, a `porcaoDescrita` que originou o número — é ela que o
...
- Converta porções em linguagem comum ("uma colher de arroz", "uma fatia de presunto", "um prato") para gramas plausíveis do Brasil, e repita em porcaoDescrita a porção exatamente como o atleta a descreveu.
