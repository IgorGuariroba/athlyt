...
export function consolidarAvaliacaoVisual(entrada: {
  ...
  const confianca = entrada.limitacoes.length === 0 ? "alta" : entrada.limitacoes.length <= 2 ? "moderada" : "baixa";
  return {
    ...
    confianca: confianca as "alta" | "moderada" | "baixa",
