...
import { CabecalhoPlanoAtivo, CartaoPlanoAtivo, CartaoPlanoAtivoCabecalho, CartaoPlanoAtivoSecao, CartaoSessaoDoDia, CartaoSessaoDoDiaAcao, CartaoSessaoDoDiaCorpo, MetricasPlanoAtivo, PersonalizacaoPendente } from "./cartoes-treino";

const meta = { title: "Treino/Cartões", component: CartaoSessaoDoDia, args: { children: null } } satisfies Meta<typeof CartaoSessaoDoDia>;
export default meta;
...
export const Personalizacao: Story = { render: () => <PersonalizacaoPendente>Aprimore sua personalização</PersonalizacaoPendente> };
