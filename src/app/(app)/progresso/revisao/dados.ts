...
export type RevisaoApresentacao = {
  ...
  proposta: { tipo: "manter" | "auto_aplicado" | "estrutural"; exigeAprovacao: boolean; justificativa: string; ajuste?: { tipo: "reduzir-volume"; limitePercentual: number; regraVersao: string } };
};
